...
<select id="getPage" resultType="cn.daenx.modules.test.domain.dto.testData.TestDataPageVo">
    SELECT td.*,
...
<select id="getPageWrapper" resultType="cn.daenx.modules.test.domain.dto.testData.TestDataPageVo">
    SELECT td.*,
    su1.username as createName,
    su2.username as updateName,
    sd.NAME as createDept
