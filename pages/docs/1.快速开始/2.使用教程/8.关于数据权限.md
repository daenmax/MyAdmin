...
<select id="getPage" resultType="cn.daenx.data.test.domain.dto.TestDataPageDto">
    SELECT td.*,
...
<select id="getPageWrapper" resultType="cn.daenx.data.test.domain.dto.TestDataPageDto">
    SELECT td.*,
    su1.username as createName,
    su2.username as updateName,
    sd.NAME as createDept
