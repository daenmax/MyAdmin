...
heroText: MyAdmin
tagline: 🚀基于SpringBoot3.x的通用后台权限管理系统
actionText: 开始使用 →
actionLink: /pages/67d5bc/
bannerBg: none # auto => 网格纹背景(有bodyBgImg时无背景)，默认 | none => 无 | '大图地址' | background: 自定义背景样式       提示：如发现文本颜色不适应你的背景时可以到palette.styl修改$bannerTextColor变量

features: # 可选的
  - title: 主流技术栈
    details: SpringBoot3、MyBatisPlus、Sa-Token、Druid、SpringDoc等
  - title: 基础功能健全
    details: 数据权限、工作流、系统参数配置、S3协议封装、邮件封装、短信封装等
  - title: 前后端分离
    details: 前端基于Vue + ElementUi，后端基于SpringBoot

# 文章列表显示方式: detailed 默认，显示详细版文章列表（包括作者、分类、标签、摘要、分页等）| simple => 显示简约版文章列表（仅标题和日期）| none 不显示文章列表
postList: none
---
<p align="center">
  <a class="become-sponsor" href="/pages/672c57/">支持这个项目</a>
</p>
...
<table>
  <tbody>
    <tr>
      ...
      <td align="center" valign="middle">
        <img :src="$withBase('/img/首页图片/qqGroup.png')" alt="群号: 373752019" class="no-zoom" style="width:120px;margin: 10px;">
